  ...
  return (
    <>
      ...
      >
          ...
          >
            {({
              ...
              <form className="w-full max-w-md  " onSubmit={handleSubmit}>
                ...
                <p className="mt-4 text-center text-gray-600 dark:text-gray-400 loginAfterandBefor">
                  or
                </p>
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md px-8 py-1  rounded-3xl ">
          <CommentLink to="/login">
            <IoArrowBackSharp />
            <span className="mx-2 hover:mx-5  transition-all">Back</span>
          </CommentLink>
        </div>
      </div>
    </>
